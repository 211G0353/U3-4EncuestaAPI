...
//        => optionsBuilder.UseMySql("server=localhost;user=root;password=root;database=encuastas", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.34-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Aplicacionencuesta>(entity =>
        {
            ...
            entity.ToTable("aplicacionencuesta");
        ...
        modelBuilder.Entity<Detallerespuesta>(entity =>
        {
            ...
            entity.ToTable("detallerespuesta");
